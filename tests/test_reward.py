...
from mjaigym.reward import KyokuScoreReward, HoraActionReward
...
def test_hora_action_reward():
    ...
    actions = []
    actions.append({"type": "start_kyoku", "bakaze": "E", "kyoku": 1, "honba": 0, "kyotaku": 0, "oya": 3, "dora_marker": "2s", "tehais": [["9p", "1m", "P", "S", "3s", "3m", "E", "7p", "3m", "S", "3m", "3p", "8m"], ["6m", "3m", "W", "E", "4p", "C", "E", "5s", "3p", "3s", "2m", "2m", "C"], ["5s", "W", "8p", "3p", "4p", "N", "F", "N", "9p", "1s", "5pr", "2s", "9p"], ["S", "5mr", "7s", "6p", "4p", "7p", "9p", "4s", "8p", "3s", "9m", "7m", "2p"]]})
    actions += [{"type":"none"}] * 5
    actions.append(
        {
            "type":"hora",
