...
class Yama:
    ...
    def paifu_tsumo(self, pai):
        ...
        self._yama[self._pointer], self._yama[self._pointer + pai_index] = (
            self._yama[self._pointer + pai_index],
            self._yama[self._pointer],
        )
        return self.tsumo()
    ...
    def paifu_open_doramarker(self, pai):
        rest_yama = [y.str for y in self._yama[self._pointer :]]
        pai_index = rest_yama.index(pai)
        self._yama[-1], self._yama[self._pointer + pai_index] = (
            self._yama[self._pointer + pai_index],
            self._yama[-1],
        )
